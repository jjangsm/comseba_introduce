...
const skillDescriptionContent =
{
    C:
    [
        "C언어 환경, C언어 개요 및 특징, 컴파일러 사용법, C언어 기본 문법",
...
const makeSkillDecription = () =>
    {
        ...
        {
            const curstep = document.querySelector(`.home_learn-skills_flex-box .step${idx + 1} p:nth-child(2)`);
    ...
    skillBox.forEach((box) =>
        {
            ...
            box.addEventListener("click",(e)=> 
            {
                ...
                for(const box of boxs)
                    {
                        if(box.textContent==skill) box.className="home_learn-skills_skill-box selected";
                        else box.className="home_learn-skills_skill-box";
                    }
                    makeSkillDecription();
            });
        });
